...
# download configs
cd $HOME
wget "https://raw.githubusercontent.com/oraichain/cosmosia/dev/monitor/loki/config.yaml"
wget "https://raw.githubusercontent.com/oraichain/cosmosia/dev/monitor/loki/promtail_config.yaml"

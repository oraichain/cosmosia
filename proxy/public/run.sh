...
curl -s https://raw.githubusercontent.com/oraichain/cosmosia/dev/proxy/public/nginx.conf > $HOME/nginx.conf.template
...
curl -Ls "https://raw.githubusercontent.com/oraichain/cosmosia/dev/proxy/public/generate_upstream.sh" > $HOME/generate_upstream.sh
sleep 1

...
curl -Ls "https://raw.githubusercontent.com/oraichain/cosmosia/dev/load_balancer/haproxy/generate_upstream.sh" > $HOME/generate_upstream.sh
...
curl -Ls "https://raw.githubusercontent.com/oraichain/cosmosia/dev/load_balancer/haproxy/start.sh" > $HOME/start.sh
curl -Ls "https://raw.githubusercontent.com/oraichain/cosmosia/dev/load_balancer/haproxy/reload.sh" > $HOME/reload.sh
